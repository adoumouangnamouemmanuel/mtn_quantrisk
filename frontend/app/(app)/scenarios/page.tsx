...
import { Activity, Play, Download, GitCompare } from 'lucide-react';
          ...
          {!active ? (
            ...
            <>
              ...
              <button
                onClick={handleRun}
                disabled={isRunning}
                className="w-full py-4 rounded-xl font-mono font-bold text-sm uppercase tracking-widest transition-all flex items-center justify-center gap-3 bg-mtn-yellow text-black hover:bg-mtn-yellow/90 disabled:opacity-60 disabled:cursor-not-allowed active:scale-[0.99]"
              >
                {isRunning ? (
                  <>
