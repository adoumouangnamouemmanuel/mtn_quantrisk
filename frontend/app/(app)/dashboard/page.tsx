    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-on-surface-variant mt-1">Live monitoring of 14 foundational KPIs (FY25 Base Case)</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-8">
          {categories.map(category => {
            ...
            return (
              <div key={category}>
                <h2 className="text-sm font-mono text-outline uppercase tracking-widest mb-4 border-b border-outline/20 pb-2">
                  {category} Metrics
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
